...
public:
	...
	// Physics functions
	void ApplyCentralForce(const enVector3 &force);
	void ApplyTorque(const enVector3 &torque);
	enVector3 GetAngularVelocity();
	void SetAngularVelocity(const enVector3 &velocity);
	enVector3 GetPosition();
